<div class="form-g	roup card-body">
	...
	<div class="form-group">
		...
		<input type="text" id="telefone" class="config form-control" name="telefone_txt" 
		placeholder="Insira o telefone" title="Telefone" 
		value="<?php echo $registro_contato["telefone"]; ?>" required />
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<input type="number" id="numero" class="config form-control" name="numero_txt" 
		placeholder="Insira o número da casa" title="Número"
		value="<?php echo $registro_contato["log_numero"]; ?>"	required />
	</div>
	<div class="form-group">
